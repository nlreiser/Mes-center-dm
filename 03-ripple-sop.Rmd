...
2. [Here](https://nuwildcat.sharepoint.com/:x:/s/FSM-MesulamCenterDataMgmt/EVeplthMmv5PsGBMNRwoEh8BTB6F_DVIbxS7rJ71LBFtmw?e=vLd17w) is a link to all of the custom variables that are used in the Mesulam Center Ripple accompanied by a description of each variable and which study’s ripple page each variable is available in. 
